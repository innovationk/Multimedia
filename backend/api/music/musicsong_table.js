...
export default class MusicSongTable extends MariadbTable {
    static _label = `musicsong`;
    ...
    static _schema = {
        ...
        musicalbum_id: { dataType: MariadbEnums.DataTypes.BIGINT_UNSIGNED, nullable: false, index: true },
